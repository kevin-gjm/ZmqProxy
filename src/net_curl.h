#ifndef ASYNCUSERINFO_CURL_H_
#define ASYNCUSERINFO_CURL_H_

//参考 https://blog.csdn.net/u011857683/article/details/53046295
...
//for test
#define  EPRINT  LogError
#define  DPRINT  LogInfo
...
#define DEFAULT_TIMEOUT          10 //传输最长时间
...
private:
	...
	//curl一些公用操作
	int messagePublicMethod(const int nFormat,bool bneeduserpasswd=true);
